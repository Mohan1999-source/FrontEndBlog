...
import { getFirestore, collection, addDoc ,deleteDoc,updateDoc,doc,getDocs, arrayUnion } from "firebase/firestore";
...
export { db,storage, ref, uploadBytes, getDownloadURL,collection, addDoc,deleteDoc ,updateDoc,doc,getDocs, arrayUnion };